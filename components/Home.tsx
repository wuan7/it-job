...
const HomeLayout = () => {
    const [filters, setFilters] = useState<FiltersType>({ location: '', salary: '', experience: '', searchQuery: '' });
  ...
  return (
    <>
        ...
        <Card jobs={jobs} error={error} loading={loading} currentPage={currentPage} setCurrentPage={setCurrentPage} />
    </>
  )
}
